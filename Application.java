...
public static void sellDrink() {
  ...
  do {
    ...
    int choice = Lectura.readInt("Escoge una bebida (su numero)");
    Drink selected = drinks.get(choice);
    ...
    choice = Lectura.readInt("Ingresar tamano (su numero)");
    selected.setSize(sizes[choice]);
    added.add(selected);
...
do {
  ...
  int choice = Lectura.readInt("Escoge un ingrediente (su numero)");
  Ingredient selected = ingredients.get(choice);
