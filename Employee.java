  ...
  String name = Lectura.readString();
    for(int x = 0; x < 7; i++){
      ...
      for(int y = 0; y < clients; y++){
        ...
        suggestionClients[i] = secretSuggestion;
      }
...
public String suggestionReport(){
  ...
  return "Employee suggestion: " + suggestionEmployee;
}
//Display
  public String toString(){
    return "Employee Report:" + employeeReport() + "Suggestions Report:" + suggestionReport();
  }
}
